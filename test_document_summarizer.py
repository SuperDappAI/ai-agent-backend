...
async def test_flexible_document_summarizer():
    ...
    mock_llm.agenerate.return_value = MagicMock(generations=[[MagicMock(text='summarized text')]])
    ...
    mock_document.page_content = "original text"
    ...
    expected_messages = [[SystemMessage(content=expected_prompt), HumanMessage(content='original text')]]
